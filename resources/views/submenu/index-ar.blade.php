            ...
            <div class="x_content">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <br />
                        <div class="">
                            <p><strong>{{ $product->ar_product_name }}</strong>
                            </p>
                            ...
                            <div class="row">
                                                        ...
                                                        <div class="input-group">
                                                            <button type="button" class="btn btn-round btn-success"
                                                                ...
                                                                data-target=".bs-example-modal-lg"><i
                                                                    class="fa fa-plus-circle"></i> عنصر جديد</button>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form id="create-menu"
                                                                                ...
                                                                                <div class="item form-group">
                                                                                    <label
                                                                                        class="col-form-label col-md-3 col-sm-3 label-align"
                                                                                        for="ar_item_name">الاسم العربي<span
                                                                                            class="required">*</span>
                                                                                    </label>
                                                                                    <div class="col-md-6 col-sm-6 ">
                                                                                        <input type="text"
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <form method="get" action="{{ Route('store_cart.store-ar') }}"
                                        class="form-horizontal form-label-left">
                                            ...
                                            <div class="x_content">
                                                <div class="form-group">
                                                    ...
                                                    <label class="btn btn-default" data-toggle-class="btn-primary"
                                                        ...
                                                        <input type="radio" name="{{ $item->ar_item_name }}" class="flat"
                                                            value="{{ $item->id }}">
                                        ...
                                        <div class="x_panel" style="align-content: center">
                                            ...
                                            <div class="x_content text-center">
                                                ...
                                                <button type="submit" class="btn btn-round btn-success">إضافة الى السلة</button>
                                                @endif
                                    </form>
                                </div>
                            </div>
