    ...
    <div class="row">
        <div class="col-md-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>مراجعة الطلب</h2>
                     &nbsp;<a class="btn btn-round btn-success" href="{{ Route('product-categories.rest-cat-ar',Session::get('rest_id')) }}"><i class="fa fa-plus-circle"></i></a>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <div class="row">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="btn btn-round btn-danger" href="
                                                    ...
                                                    'ar_description'=>$cart->ar_description
                                                    ]
