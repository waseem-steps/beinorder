...
<div class="right_col" role="main">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form id="create-menu" class="form-horizontal form-label-left" action="{{ Route('cart.final_confirm-ar') }}"
                                ...
                                <div class="item form-group">
                                    <div class="col-md-12 col-sm-12 text-left">
                                        <input type="radio" name="payment_method" checked class="flat" value="CASH">&nbsp;<i class="fa fa-money fa-lg"
                                            checked="checked"></i>&nbsp;كاش
                                        <input type="radio" name="payment_method"  class="flat" value="CREDIT">&nbsp;<i class="fa fa-cc-visa fa-lg"></i>&nbsp;دفع بالبطاقة<br />
