            ...
            <div class="x_panel">
                <div class="x_content">
                    ...
                    <form id="create-restaurant" data-parsley-validate class="form-horizontal form-label-left"
                        ...
                        {{csrf_field()  }}
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="rest_name">Restaurant
                        ...
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="ar_rest_name">Restaurant
