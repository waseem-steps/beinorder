        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                ...
                <form id="update-branch" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data"
                    action="{{ Route('product-category.update',$cat->id) }}" method="POST">
                    {{csrf_field()  }}
                    ...
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="ar_category_name">Arabic Category
                    ...
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="img">Product Category
