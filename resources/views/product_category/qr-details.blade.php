                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <div class="item form-group">
                                                                                        <label
                                                                                            ...
                                                                                            for="branch_name">Branch Name<span
                                                                                                class="required">*</span>
                                                                                        </label>
                                                                                    ...
                                                                                    <div class="item form-group">
                                                                                        <label
                                                                                            class="col-form-label col-md-3 col-sm-3 label-align"
                                                                                            for="ar_branch_name">Arabic Branch Name<span class="required">*</span>
                                                                                        </label>
                                                                                        <div class="col-md-6 col-sm-6 ">
                                                                                            <input type="text"
                                                                                                id="ar_branch_name"
                                                                                    ...
                                                                                    <div class="item form-group">
                                                                                        <label
                                                                                            class="col-form-label col-md-3 col-sm-3 label-align"
                                                                                            for="phone_number">Phone Number<span class="required">*</span>
                                                                                        </label>
                                                                                        <div class="col-md-6 col-sm-6 ">
                                                                                            <input type="text"
                                                                                                id="phone_number"
                                                                                    ...
                                                                                    <div class="item form-group">
                                                                                        <label
                                                                                            class="col-form-label col-md-3 col-sm-3 label-align"
                                                                                            for="ar_address">Arabic Address<span class="required">*</span>
                                                                                        </label>
                                                                                        <div class="col-md-6 col-sm-6 ">
                                                                                            <input type="text"
                                                                                                id="ar_address"
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    ...
                                                                                    <div class="item form-group">
                                                                                        <label
                                                                                            class="col-form-label col-md-3 col-sm-3 label-align"
                                                                                            for="c_password">Confirm Password<span class="required">*</span>
                                                                                        </label>
                                                                                        <div class="col-md-6 col-sm-6 ">
                                                                                            <input type="password"
                                                                                                id="c_password"
                                    ...
                                    <div class="input-group">
                                        <button type="button" class="btn btn-round btn-success"
                                            ...
                                            data-target=".bs-example-modal-lg"><i
                                                class="fa fa-plus-circle"></i>New Category
                                        </button>
