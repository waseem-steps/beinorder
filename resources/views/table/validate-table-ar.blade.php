    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>الجاء إدخال كود الطاولة</small></h3>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="well profile_view"
                        ...
                        <form id="create-restaurant" data-parsley-validate class="form-horizontal form-label-left"
                            action="{{ Route('table.valid-ar') }}" method="GET" enctype="multipart/form-data">
                            {{csrf_field()  }}
                            <input type="hidden" name="rest_id" id="rest_id" value="{{ $rest_id }}">
                            <input type="hidden" name="table_id" id="table_id" value="{{ $table_id }}">
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="table_code">كود الطالوة<span class="required">*</span>
                                </label>
                            ...
                            <button type="submit" class="btn btn-round btn-success" >
                                <i class="fa fa-search"></i> عرض أنواع المنتجات
