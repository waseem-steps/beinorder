            ...
            <div class="col-md-12 col-sm-12 ">
				...
				action="
					@if($rest->table_code_status == 1)
						{{ Route('table.product-categories-ar') }}
					@else
						{{ Route('cart.checkout-table-ar') }}
					@endif"
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <a onclick="return confirm('هل أنت متأكد من حذف العنصر؟');"
                                class="btn btn-danger" href="{{ Route('submenu.delete-ar',$menu->id) }}"><i
                        ...
                        <div class="x_content">
                            <div class="form-group">
                                ...
                                @if(Session::get('user_role')!='Anonymous')
                                <a onclick="return confirm('هل أنت متأكد من حذف العنصر؟');"
                                    class="btn btn-danger" href="{{ Route('submenu-item.delete-ar',$item->id) }}"><i
                                        class="fa fa-remove"></i></a>
                                @endif
                                <br />
							...
							<div class="x_panel">
								<div class="x_content text-center">
									...
									@if($rest->table_code_status == 0)
										<button type="submit" class="btn btn-round btn-success" onClick="this.form.submit(); this.disabled=true;">إضافة طلب</button>
									@endif
									<!-- Table Code Enabled -->
									@if($rest->table_code_status == 1)
										<button type="button" class="btn btn-round btn-success" data-toggle="modal" data-target=".bs-example-modal-lg">إضافة طلب</button>
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title" id="myModalLabel">الرجاء إدخال كود الطاولة ...</h4>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div 	class="modal fade bs-example-modal-lg"
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title" id="myModalLabel">قائمة جديدة</h4>
                                                        ...
                                                        <div class="modal-body">
                                                            <form id="create-menu"
                                                                ...
                                                                <div class="item form-group">
                                                                    <label
                                                                        class="col-form-label col-md-3 col-sm-3 label-align"
                                                                        for="ar_menu_name">نوع القائمةe<span class="required">*</span>
                                                                    </label>
                                                                    <div class="col-md-6 col-sm-6 ">
                                            ...
                                            <div class="input-group">
                                                <button type="button" class="btn btn-round btn-success"
                                                    data-toggle="modal" data-target=".bs-example-modal-lg12"><i
                                                        class="fa fa-plus-circle"></i> إضافة عنصر</button>
                                                    ...
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="create-menu"
                                                                    class="form-horizontal form-label-left"
                                                                    action="{{ Route('submenu-item.store-ar') }}"
