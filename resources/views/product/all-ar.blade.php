    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>إدارة المنتجات</small></h3>
            </div>
            <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                    <div class="input-group">
                        <button type="button" class="btn btn-round btn-success" data-toggle="modal"
                            data-target=".bs-example-modal-lg"><i class="fa fa-plus-circle"></i> منتج جديد</button>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="myModalLabel">منتج جديد</h4>
                                        ...
                                        <form id="create-restaurant" data-parsley-validate
                                            ...
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3 label-align"
                                                    for="product_name">اسم المنتج<span class="required">*</span>
                                                </label>
