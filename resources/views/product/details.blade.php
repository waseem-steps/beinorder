                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                ...
                                <a onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-danger"
                                    href="{{ Route('submenu.delete',$menu->id) }}"><i class="fa fa-remove"></i></a>
                                @endif
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                <div class="form-group">
                                    ...
                                    as $key => $item)
                                        ...
                                        @if(Session::get('user_role')!='Anonymous')
                                        <a onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-danger"
                                            href="{{ Route('submenu-item.delete',$item->id) }}"><i class="fa fa-remove"></i></a>
                                        @endif
                                        <br />
                        ...
                        <div class="x_panel">
                         ...
                         @foreach(App\Http\Controllers\SubmenuItemController::getItems($menu->id)
                                    ...
                                    <input type="hidden" id="id{{ $item->id }}"name="test[]" value="-1">
                                        ...
                                        ({{ App\Http\Controllers\CountryController::getCurrency(Session::get('rest_id'))}})
                                        @if(Session::get('user_role')!='Anonymous')
                                        <a onclick="return confirm('Are you sure you want to delete this item?');" class="btn btn-danger" href="{{ Route('submenu-item.delete',$item->id) }}"><i class="fa fa-remove"></i></a>
                                        @endif
                                    </label>
                                    <br />
                                    @endforeach
                                ...
                                <div class="col-md-12 col-sm-12 text-left">
                                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group">
                                                <button type="button" class="btn btn-round btn-success" data-toggle="modal"
                                                    data-target=".bs-example-modal-lg12"><i class="fa fa-plus-circle"></i> New
                                                    Item</button>
                                                ...
                                                <div class="modal fade bs-example-modal-lg12" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="create-menu" class="form-horizontal form-label-left"
                                                                    action="{{ Route('submenu-item.store') }}" method="POST"
