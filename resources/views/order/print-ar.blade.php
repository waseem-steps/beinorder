                ...
                <div class="x_panel" id='dt_name{{ $order->id }}'>
                    <div class="x_title">
                        <h2>{{ $order->order_code }} <small>@if($order->order_status_id==1)
                            ...
                            <a href="{{Route('order.confirm-ar',$order->id)  }}"><i class="fa fa-cutlery fa-lg"></i></a>
                            @endif

                            @if($order->order_status_id==2)
                            <a href="{{Route('order.checkout-ar',$order->id)  }}"><i class="fa fa-check fa-lg"></i></a>
                            @endif
