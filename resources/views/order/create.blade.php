        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <form id="update-restaurant" data-parsley-validate class="form-horizontal form-label-left"
                    action="{{ Route('order_details.new_order') }}" method="POST">
                    {{csrf_field()  }}
                    ...
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="order_code">Order Code
                        </label>
                    ...
                    <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="rest_name">Restaurant Name
                        </label>
                        <div class="col-md-6 col-sm-6 ">
